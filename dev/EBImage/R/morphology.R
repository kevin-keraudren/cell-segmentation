...
## - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
erode = function (x, kern=makeBrush(5, shape='diamond'), iter, binary=TRUE) {
  validImage(x)
  if (colorMode(x)==TrueColor) stop("this method doesn't support the \'TrueColor\' color mode")
...
## - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
dilate = function (x, kern=makeBrush(5, shape='diamond'), iter, binary=TRUE) {
  validImage(x)
  if (colorMode(x)==TrueColor) stop("this method doesn't support the \'TrueColor\' color mode")
  if (!missing(iter)) warning("'iter' is a deprecated argument.")  
...
## - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
opening = function (x, kern=makeBrush(5, shape='diamond'), iter, binary=TRUE) {
  validImage(x)
  if (!missing(iter)) warning("'iter' is a deprecated argument.")  
...
## - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
closing = function (x, kern=makeBrush(5, shape='diamond'), iter, binary=TRUE) {
  validImage(x)
  if (!missing(iter)) warning("'iter' is a deprecated argument.")  
